...
public class ShaderCompilationTests
{
    ...
    public void ShaderStages_CanCombineMultiple()
    {
        ...
        Assert.That(combined, Has.Flag(ShaderStages.Vertex));
        Assert.That(combined, Has.Flag(ShaderStages.Fragment));
        Assert.That(combined, Does.Not.Have.Flag(ShaderStages.Compute));
    }
}
